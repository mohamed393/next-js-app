...
const ErrorPage = ({error,reset}:ErrorPageProps) => {
  return (
    ...
    <div className="text-3xl text-red-600 text-semibold">Some thing went wrong</div>
    ...
    <Link className="text-xl underline text-blue-700 mt-6 block" href='/'>Go to home page</Link>
